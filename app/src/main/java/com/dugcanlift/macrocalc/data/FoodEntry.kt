...
internal fun foodEntryFromJson(o: JSONObject): FoodEntry = FoodEntry(
    ...
    calories = o.finiteInt("calories", 0),
    proteinG = o.finiteInt("proteinG", 0),
    fatG = o.finiteInt("fatG", 0),
    carbsG = o.finiteInt("carbsG", 0),
    fiberG = o.finiteInt("fiberG", 0),
    date = o.optString("date", todayKey()),
    loggedAt = o.finiteLong("loggedAt", 0L),
